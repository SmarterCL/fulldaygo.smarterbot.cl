...
import { LoginButton } from "@/templates/login/LoginButton"
import { LoginInput } from "@/templates/login/LoginInput"
...
const DEFAULT_BG = "/design/login-theme/login-bg.svg"
  ...
  const handleGoogleRedirect = async () => {
    ...
    try {
      ...
      await signIn.authenticateWithRedirect({
        ...
        redirectUrlComplete: redirectUrl || window.location.href,
      ...
      <div className="so-login-card">
        <div className="so-login-card-content">
          ...
          <section className="so-login-metadata">
            ...
            <span>Redirección: {redirectUrl ? redirectUrl : "mobile-app"}</span>
